...
def setup_training_loop_kwargs(
    ...
    # ------------------------------------------
    # Dataset: data, cond, subset, mirror, rcrop
    # ------------------------------------------

    assert data is not None
    assert isinstance(data, str)
    args.training_set_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDataset', path=data, use_labels=True, max_size=None, xflip=False, rcrop=rcrop)
    ...
    augpipe_specs = {
        ...
        'pixel':  dict(xflip=1, rotate90=1, xint=1, brightness=1, contrast=1, lumaflip=1, hue=1, saturation=1),
    }
...
@click.option('--augpipe', help='Augmentation pipeline [default: bgc]', type=click.Choice(['blit', 'geom', 'color', 'filter', 'noise', 'cutout', 'bg', 'bgc', 'bgcf', 'bgcfn', 'bgcfnc', 'pixel']))
...
def main(ctx, outdir, dry_run, **config_kwargs):
    ...
    print(f'Random crop size:   {args.training_set_kwargs.rcrop}')
    print()
